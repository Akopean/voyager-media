...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_sortablejs__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_toastr__ = __webpack_require__(13);
...
// Create Bus Vue
var voyager_media_bus = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a();
var cropper, croppingImage, new_folder_path;
//Create Media Sortable Box
var el = document.getElementById('mediaImageList');
var sortable = __WEBPACK_IMPORTED_MODULE_1_sortablejs___default.a.create(el, {
  group: 'items',
  sort: true,
...
//Create Trash Box
var el_trash = document.getElementById('voyager-media__trash');
__WEBPACK_IMPORTED_MODULE_1_sortablejs___default.a.create(el_trash, {
  group: 'items',
  onAdd: function onAdd(evt) {
    var id = $(evt.item).data('id');
    var name = $(evt.item).data('name');
  ...
  if (document.getElementById('filemanager')) {
    ...
    new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
      ...
      created: function created() {
        ...
        var media_input = $('#media-input');
        var multiple = $(media_input).data('multiple');
        var data = $(media_input).data('value') || '';
        ...
        voyager_media_bus.$on('acceptFile', function () {
        ...
        voyager_media_bus.$on('selectedFileRemove', function () {
          //this.selected_file = null
        });
        // if selected some file
        voyager_media_bus.$on('selectedFile', function (new_file) {
          _this.selected_file = new_file;
        });
        // if sorted some file
        voyager_media_bus.$on('sortingFile', function (order) {
          _this.sortingFile(order);
        });
        // if removed some file
        voyager_media_bus.$on('removeFile', function (id, name) {
          __WEBPACK_IMPORTED_MODULE_2_toastr___default.a.success('successfully deleted ' + name, 'Sweet Success!');
          _this.removeFile(id);
        });
      },

      methods: {
        initDataFiles: function initDataFiles($files) {
        ...
        renderHtml: function renderHtml(file) {
        ...
        updateFirstElement: function updateFirstElement(file) {
        ...
        updateImageInputData: function updateImageInputData() {
          var data = [];
          ...
          var value = this.multiple ? JSON.stringify(data) : data[0];
          $('#media-input').val(value);
        },
        sortingFile: function sortingFile(order) {
          var data = new Map();
          var i = 0;
        ...
        acceptFile: function acceptFile() {
        ...
        showFile: function showFile() {
          var file_name = this.selected_file.path.replace(this.base_url + '/storage/', '');
          this.renderHtml(file_name);
        },

        // show modal media manager
        showMedia: function showMedia(event) {
    ...
    var manager = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
      ...
      methods: {
        mediaButtonSelect: function mediaButtonSelect(event) {
          if (this.selectedFileIs('folder')) {
            __WEBPACK_IMPORTED_MODULE_2_toastr___default.a.info('Select Some File');
            return;
          }
          voyager_media_bus.$emit('acceptFile');
        },
        mediaButtonClose: function mediaButtonClose(event) {
          $('#voyager-media').hide();
          voyager_media_bus.$emit('selectedFileRemove');
        },
        selectedFileIs: function selectedFileIs(val) {
          if (typeof this.selected_file !== "undefined" && this.selected_file.hasOwnProperty('type') && typeof this.selected_file.type !== 'undefined' && this.selected_file.type.includes(val)) {
            return true;
          }
          return false;
        },
    ...
    var VoyagerMedia = function VoyagerMedia(o) {
      ...
      this.init = function () {
        $('#upload').dropzone({
          ...
          success: function success(e, res) {
            if (res.success) {
              __WEBPACK_IMPORTED_MODULE_2_toastr___default.a.success(res.message, 'Sweet Success!');
            } else {
              __WEBPACK_IMPORTED_MODULE_2_toastr___default.a.error(res.message, 'Whoopsie!');
            }
          },
          error: function error(e, res, xhr) {
            __WEBPACK_IMPORTED_MODULE_2_toastr___default.a.error(res, 'Whoopsie');
          },
        ...
        var isBrowsingFiles = null,
            fileBrowserActive = function fileBrowserActive(el) {
          ...
          if ($.contains(files.parent()[0], el[0])) {
            ...
            handleFileBrowserStatus = function handleFileBrowserStatus(target) {
        ...
        $(document).keydown(function (e) {
          if (!$('.modal').hasClass('in')) {
            ...
            if ((e.which == 37 || e.which == 38) && parseInt(curSelected)) {
              var newSelected = parseInt(curSelected) - 1;
              setCurrentSelected($('*[data-index="' + newSelected + '"]'));
            }
            // right key
            if ((e.which == 39 || e.which == 40) && parseInt(curSelected) < manager.files.items.length - 1) {
              var _newSelected = parseInt(curSelected) + 1;
              setCurrentSelected($('*[data-index="' + _newSelected + '"]'));
            }
            // enter key
        ...
        $('#new_folder_submit').click(function () {
          ...
          $.post(options.baseUrl + '/media/new_folder', {
            ...
            if (data.success == true) {
              __WEBPACK_IMPORTED_MODULE_2_toastr___default.a.success('successfully created ' + $('#new_folder_name').val(), 'Sweet Success!');
              getFiles(manager.folders);
            } else {
              __WEBPACK_IMPORTED_MODULE_2_toastr___default.a.error(data.error, 'Whoops!');
            }
            $('#new_folder_name').val('');
        ...
        $('#confirm_delete').click(function () {
          ...
          $.post(options.baseUrl + '/media/delete_file_folder', {
            ...
            if (data.success == true) {
              __WEBPACK_IMPORTED_MODULE_2_toastr___default.a.success('successfully deleted ' + manager.selected_file.name, 'Sweet Success!');
              getFiles(manager.folders);
        ...
        $('#move_btn').click(function () {
          var source = manager.selected_file.name;
          var destination = $('#move_folder_dropdown').val() + '/' + manager.selected_file.name;
          ...
          $.post(options.baseUrl + '/media/move_file', {
            ...
            if (data.success == true) {
              __WEBPACK_IMPORTED_MODULE_2_toastr___default.a.success('Successfully moved file/folder', 'Sweet Success!');
              getFiles(manager.folders);
            } else {
              __WEBPACK_IMPORTED_MODULE_2_toastr___default.a.error(data.error, 'Whoops!');
            }
        ...
        $('#rename_btn').click(function () {
          var source = manager.selected_file.path;
          var filename = manager.selected_file.name;
          ...
          $.post(options.baseUrl + '/media/rename_file', {
            ...
            if (data.success == true) {
              __WEBPACK_IMPORTED_MODULE_2_toastr___default.a.success('Successfully renamed file/folder', 'Sweet Success!');
              getFiles(manager.folders);
            } else {
              __WEBPACK_IMPORTED_MODULE_2_toastr___default.a.error(data.error, 'Whoops!');
            }
        ...
        function setCurrentSelected(cur) {
          if ((typeof cur === 'undefined' ? 'undefined' : _typeof(cur)) === 'object' && cur.length > 0) {
        ...
        function cropImage(createMode) {
          ...
          $.post(options.baseUrl + '/media/crop', postData, function (data) {
            if (data.success == true) {
              __WEBPACK_IMPORTED_MODULE_2_toastr___default.a.success(data.message);
              getFiles(manager.folders);
...
throw new Error("Module build failed: ModuleBuildError: Module build failed: Error: ENOENT: no such file or directory, open 'G:\\OpenServer\\domains\\localhost\\Laravel\\Laravel+Voyager+Shop\\VoyagerMedia\\resources\\assets\\scss\\app.scss'\n    at runLoaders (G:\\OpenServer\\domains\\localhost\\Laravel\\Laravel+Voyager+Shop\\VoyagerMedia\\node_modules\\webpack\\lib\\NormalModule.js:195:19)\n    at G:\\OpenServer\\domains\\localhost\\Laravel\\Laravel+Voyager+Shop\\VoyagerMedia\\node_modules\\loader-runner\\lib\\LoaderRunner.js:364:11\n    at G:\\OpenServer\\domains\\localhost\\Laravel\\Laravel+Voyager+Shop\\VoyagerMedia\\node_modules\\loader-runner\\lib\\LoaderRunner.js:200:19\n    at G:\\OpenServer\\domains\\localhost\\Laravel\\Laravel+Voyager+Shop\\VoyagerMedia\\node_modules\\enhanced-resolve\\lib\\CachedInputFileSystem.js:70:14\n    at _combinedTickCallback (internal/process/next_tick.js:131:7)\n    at process._tickCallback (internal/process/next_tick.js:180:9)");
