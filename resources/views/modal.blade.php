<style>
    ...
    .voyager-media__trash .media-list-group__item {
        display: none;
    }
    .remove_image{
        cursor: pointer;
    ...
    .media-list__group .media-list-group__item {
        display: inline-block;
        padding: 5px;
    }
   .media-list__group .media-list-group__item img {
       width: 70px;
       height: auto;
   }
    .media-list__group .media-list-group__item:first-child {
        display: block;
        text-align: center;
    }
    .media-list__group .media-list-group__item:first-child img{
        width: 250px;
        height: auto;
    }

    .voyager-media__modal {
        position: fixed;
        top: 30px;
        left: 30px;
        right: 30px;
    ...
    .voyager .modal.modal-danger .vg-modal-header {
        background-color: #FA2A00;
        color: #FFF;
    }

    .btn, .modal .modal-dialog .vg-modal-header {
        font-family: 'Open Sans', sans-serif;
    }

    .modal-danger .vg-modal-header {
    ...
    .voyager-media__modal .page-content {
        position: absolute;
        top: 0;
        left: 0;
        right: 0;
    ...
    .voyager-media__modal .page-content .row {
        margin: 0;
    }
</style>
<div tabindex="0" id="voyager-media" style="position: relative; display: none">
    <div class="voyager-media__modal">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div id="filemanager">
                        ...
                        <div id="toolbar">
                            <div class="btn-group offset-right">
                                ...
                                <button type="button" class="btn btn-primary" id="new_folder"
                                        onclick="jQuery('#new_folder_modal').modal('show')"><i
                                            class="voyager-folder"></i>
                            ...
                            <div class="btn-group offset-right">
                                <button type="button" class="btn btn-default" id="move"><i
                                            class="voyager-move"></i> {{ __('voyager::generic.move') }}
                                </button>
                                <button type="button" class="btn btn-default" id="rename"><i
                                            class="voyager-character"></i>
                                ...
                                <button v-show="selectedFileIs('image')" type="button" class="btn btn-default"
                                        id="crop"><i class="voyager-crop"></i>
                        ...
                        <div id="content">
                            ...
                            <div class="flex">
                                ...
                                <div id="left">
                                    ...
                                    <div id="no_files">
                                        <h3><i class="voyager-meh"></i> {{ __('voyager::media.no_files_in_folder') }}
                                        </h3>
                                    </div>
                                    ...
                                    <div class="right_details">
                                        ...
                                        <div class="detail_info">
    							            ...
    							            <p>@{{selected_file.type}}</p></span>
    								            ...
    								            <p><span class="selected_file_count">@{{ selected_file.items }}
                                                        item(s)</span><span
                            ...
                            <div class="media-toolbar" id="media-toolbar__id">
                                <div class="media-toolbar">
                                    <div class="media-toolbar-primary text-right">
                                        <i class="voyager-save"></i><input type="button" v-on:click="mediaButtonClose" id="media-button-close" class="btn btn-warning btn-lg"
                                                value="Close">
                                        </input>
                                        <button type="button" v-on:click="mediaButtonSelect" id="media-button-select" class="btn btn-primary btn-lg"
                                                style=""><i class="voyager-save"></i>
                                            Select
                                        </button>
                                    </div>
                                </div>
                        ...
                        <!-- Move File Modal -->
                        <div class="modal  modal-warning" id="move_file_modal">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title"><i
                                                    class="voyager-move"></i> {{ __('voyager::media.move_file_folder') }}
                                        </h4>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-warning"
                                                id="move_btn">{{ __('voyager::generic.move') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Rename File Modal -->
                        <div class="modal  modal-warning" id="rename_file_modal">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title"><i
                                                    class="voyager-character"></i> {{ __('voyager::media.rename_file_folder') }}
                                        </h4>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default"
                                                data-dismiss="modal">{{ __('voyager::generic.cancel') }}</button>
                                        <button type="button" class="btn btn-warning"
                                                id="rename_btn">{{ __('voyager::generic.rename') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal " id="imagemodal">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <img :src="selected_file.path" class="img img-responsive"
                                             style="margin: 0 auto;">
                                    </div>
                        ...
                        <!-- Crop Image Modal -->
                        <div class="modal modal-warning" id="confirm_crop_modal">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title"><i
                                                    class="voyager-warning"></i> {{ __('voyager::media.crop_image') }}
                                        </h4>
                                    </div>

                                    <div class="modal-body">
                                        <div class="crop-container">
                                            <img v-if="selectedFileIs('image')" id="cropping-image"
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-warning"
                                                id="crop_and_create_btn">{{ __('voyager::media.crop_and_create') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- New Folder Modal -->
                    <div class="modal modal-info" id="new_folder_modal">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"><i
                                                class="voyager-folder"></i> {{ __('voyager::media.add_new_folder') }}
                                    </h4>
                                </div>

                                <div class="modal-body">
                                    <input name="new_folder_name" id="new_folder_name"
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-info"
                                            id="new_folder_submit">{{ __('voyager::media.create_new_folder') }}
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Delete File Modal -->
                    <div class="modal modal-danger" id="confirm_delete_modal">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <h5 class="folder_warning"><i
                                                class="voyager-warning"></i> {{ __('voyager::media.delete_folder_question') }}
                                    </h5>
                                </div>
                    ...
                    <div id="dropzone"></div>
                    <!-- Delete File Modal -->
                    <div class="modal " id="upload_files_modal">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"><i
                                                class="voyager-warning"></i> {{ __('voyager::media.drag_drop_info') }}
                                    </h4>
                                </div>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-success"
                                            data-dismiss="modal">{{ __('voyager::generic.all_done') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    </div><!-- .voyager-media__modal -->
    <div class="media-modal-backdrop"></div><!-- .media-modal-backdrop -->
</div><!-- .voyager-media -->
<script src="{{  asset('/vendor/voyagermedia/assets/js/app.js') }}" ></script>
<script>
